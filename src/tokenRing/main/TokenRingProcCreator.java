...
Interface graphique offrant la possibilit� a l'utilisateur d'interagir avec l'application
...
public class TokenRingProcCreator extends JFrame {
	...
	private void initUI(ActionListener controller) {
		...
		JButton btnNewButton = new JButton("Cr�er Processus");
